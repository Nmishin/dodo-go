 ...
 * @param countryId
 * @param unitId
 * @param optional nil or *ProductsApiApiV2BrandCountryIdUnitIdProductsTopGetOpts - Optional Parameters:
     * @param "Start" (optional.String) -
     * @param "End" (optional.String) -
@return ProductStatisticsModelBrandData
*/
...
func (a *ProductsApiService) ApiV2BrandCountryIdUnitIdProductsTopGet(ctx context.Context, brand string, countryId int32, unitId int32, localVarOptionals *ProductsApiApiV2BrandCountryIdUnitIdProductsTopGetOpts) (ProductStatisticsModelBrandData, *http.Response, error) {
	var (
		...
		localVarReturnValue ProductStatisticsModelBrandData
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v2/{brand}/{countryId}/{unitId}/products/top"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ProductStatisticsModelBrandData
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param brand
 * @param optional nil or *ProductsApiApiV2BrandProductsTopGetOpts - Optional Parameters:
     * @param "Start" (optional.String) -
     * @param "End" (optional.String) -
@return ProductStatisticsModelBrandData
*/
...
func (a *ProductsApiService) ApiV2BrandProductsTopGet(ctx context.Context, brand string, localVarOptionals *ProductsApiApiV2BrandProductsTopGetOpts) (ProductStatisticsModelBrandData, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v2/{brand}/products/top"
	localVarPath = strings.Replace(localVarPath, "{"+"brand"+"}", fmt.Sprintf("%v", brand), -1)
